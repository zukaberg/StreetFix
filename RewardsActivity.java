...
public class RewardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonNotifications.setOnClickListener(v -> {
            startActivity(new Intent(RewardsActivity.this, NotificationsActivity.class));
        });

        textViewAllAchievements.setOnClickListener(v -> {
            startActivity(new Intent(RewardsActivity.this, AchievementsActivity.class));
        });

        textViewAllLeaderboard.setOnClickListener(v -> {
            startActivity(new Intent(RewardsActivity.this, LeaderboardActivity.class));
        });
